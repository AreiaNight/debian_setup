...
case $replay in
    a) 
        echo -e "${green}Installing Awesome WM...${nocolor}"
        # Llama a la función o comando para instalar Awesome
        awsm
        ;;
    b)
        echo -e "${green}Installing Bspwm...${nocolor}"
        # Llama a la función o comando para instalar Bspwm
        bspwmInstall
        ;;
    *)
        echo -e "${red}\nNot a valid option... Exiting!${nocolor}"
        exit 1
        ;;
esac
